...
describe('GetAuthenticationUseCase', () => {
  it('should orchestrating the get authentication action correctly', async () => {
    ...
    mockAuthenticationTokenManager.createAccessToken = jest.fn(() => Promise.resolve(expectedAuthentication.accessToken));
    mockAuthenticationTokenManager.createRefreshToken = jest.fn(() => Promise.resolve(expectedAuthentication.refreshToken));
