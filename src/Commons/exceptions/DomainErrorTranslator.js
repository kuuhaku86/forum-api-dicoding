...
DomainErrorTranslator._directories = {
  ...
  'DELETE_COMMENT_USE_CASE.NOT_COMMENT_OWNER': new AuthorizationError('bukan pemilik comment'),
  ...
  'DELETE_REPLY_USE_CASE.NOT_REPLY_OWNER': new AuthorizationError('bukan pemilik balasan'),
};
